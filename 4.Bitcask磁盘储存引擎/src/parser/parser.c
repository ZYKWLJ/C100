...
void argc3(disk_engine_type_t disk_engine_type, char *argv[])
{
    ...
    {
        db_erase(disk_engine_type, argv[2]);
    }
    else if (strcmp(argv[1], "find") == 0)
    {
        db_search(disk_engine_type, argv[2]);
    }
    else
    {
...
void argc4(disk_engine_type_t disk_engine_type, char *argv[])
{
    ...
    {
        db_insert(disk_engine_type, argv[2], argv[3]);
    }
    else if (strcmp(argv[1], "update") == 0)
    {
        db_update(disk_engine_type, argv[2], argv[3]);
    }
    else
    {
        printf("Error command\n");
...
void parser(disk_engine_type_t disk_engine_type, int argc, char *argv[])
{
    ...
    {
        argc3(disk_engine_type, argv);
    }
    else if (argc == 4)
    {
        argc4(disk_engine_type, argv);
    }
    else
    {
        printf("Error command\n");
